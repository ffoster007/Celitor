...
export default function UsageGuide() {
	return (
		<div className="flex min-h-0 flex-1 items-start justify-center overflow-y-auto bg-slate-950 px-6 py-10 text-slate-100">
			<div className="w-full max-w-5xl">
				<div className="mb-8 rounded-2xl border border-slate-800/70 bg-gradient-to-b from-slate-900/60 to-slate-950/40 p-6 shadow-[0_1px_0_rgba(255,255,255,0.04)]">
					<div className="flex flex-wrap items-center justify-between gap-4">
						<div className="min-w-0">
							<div className="mb-2 inline-flex items-center gap-2 rounded-full border border-slate-800 bg-slate-950/60 px-3 py-1 text-xs font-medium text-slate-300">
				...
				<div className="grid gap-4 md:grid-cols-2">
					<div className="rounded-2xl border border-slate-800/80 bg-slate-900/30 p-5 shadow-[0_1px_0_rgba(255,255,255,0.03)]">
						<div className="flex items-center gap-3">
							<FolderGit2 className="h-5 w-5 text-yellow-400" />
							<h2 className="text-lg font-semibold text-slate-50">1) Select a repository</h2>
						</div>
					...
					<div className="rounded-2xl border border-slate-800/80 bg-slate-900/30 p-5 shadow-[0_1px_0_rgba(255,255,255,0.03)]">
						<div className="flex items-center gap-3">
							...
							<h2 className="text-lg font-semibold text-slate-50">2) Choose a file</h2>
						</div>
						<ul className="mt-3 space-y-2 text-sm text-slate-300">
							<li>Click a file in Explorer to open it.</li>
							<li>
								Bridge analysis is available for code files such as{" "}
								<span className="rounded-md bg-slate-950/60 px-2 py-0.5 text-slate-100 ring-1 ring-slate-800">
									.ts / .tsx / .js / .jsx
								</span>
							</li>
						</ul>
					...
					<div className="rounded-2xl border border-slate-800/80 bg-slate-900/30 p-5 shadow-[0_1px_0_rgba(255,255,255,0.03)]">
						<div className="flex items-center gap-3">
							...
							<h2 className="text-lg font-semibold text-slate-50">3) Right‑click → Bridge</h2>
						</div>
						<ul className="mt-3 space-y-2 text-sm text-slate-300">
							<li>Right‑click the file in Explorer.</li>
							<li>Select <span className="font-medium text-slate-100">Bridge</span>.</li>
							<li>Wait for analysis to complete (large repos may take longer).</li>
						</ul>
						<div className="mt-4 flex items-start gap-2 rounded-xl bg-slate-950/60 px-3 py-2 text-xs text-slate-300 ring-1 ring-slate-800">
					...
					<div className="rounded-2xl border border-slate-800/80 bg-slate-900/30 p-5 shadow-[0_1px_0_rgba(255,255,255,0.03)]">
						<div className="flex items-center gap-3">
							...
							<h2 className="text-lg font-semibold text-slate-50">4) Read the graph</h2>
						</div>
						<ul className="mt-3 space-y-2 text-sm text-slate-300">
