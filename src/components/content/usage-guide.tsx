	...
	return (
		<div className="flex min-h-0 flex-1 items-start justify-center overflow-y-auto bg-black px-6 py-10 text-white">
			<div className="w-full max-w-5xl">
				<div className="mb-8 rounded-xl border border-gray-800/70 from-gray-900/60 bg-gray-900/30 to-black/40 p-6 shadow-[0_1px_0_rgba(255,255,255,0.04)] border-white">
				...
				<div className="grid gap-4 md:grid-cols-2">
					<div className="rounded-xl border border-gray-800/80 bg-gray-900/30 p-5 shadow-[0_1px_0_rgba(255,255,255,0.03)] border-white">
